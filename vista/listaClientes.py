...
class ListaClientes(QtWidgets.QWidget):
	#Inicializacion del Objeto QWidget
	def __init__(self):
		QWidget.__init__(self)

		#Importamos la vista "listaAfiliados" y la alojamos dentro de la variable "vistaLista"
		self.listaClientes = uic.loadUi("ui/listaclientes.ui", self)
		self.nuevo.clicked.connect(self.seleccionarCliente)

	def seleccionarCliente(self):
		detalle_cliente = cliente.Cliente()
